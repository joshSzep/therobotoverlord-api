...
INSERT INTO users (pk, email, google_id, username, role, loyalty_score, email_verified, created_at) VALUES
...
INSERT INTO topics (pk, title, description, author_pk, created_by_overlord, status, approved_at, approved_by, created_at) VALUES
...
INSERT INTO topic_tags (topic_pk, tag_pk, assigned_by_pk) VALUES
-- Welcome topic
('10000000-0000-0000-0000-000000000001', (SELECT pk FROM tags WHERE name = 'Discussion'), '00000000-0000-0000-0000-000000000001'),
('10000000-0000-0000-0000-000000000001', (SELECT pk FROM tags WHERE name = 'Debate'), '00000000-0000-0000-0000-000000000001'),

-- Logical discourse topic
('10000000-0000-0000-0000-000000000002', (SELECT pk FROM tags WHERE name = 'Logic'), '00000000-0000-0000-0000-000000000001'),
('10000000-0000-0000-0000-000000000002', (SELECT pk FROM tags WHERE name = 'Philosophy'), '00000000-0000-0000-0000-000000000001'),
('10000000-0000-0000-0000-000000000002', (SELECT pk FROM tags WHERE name = 'Theory'), '00000000-0000-0000-0000-000000000001'),

-- Technology topic
('10000000-0000-0000-0000-000000000003', (SELECT pk FROM tags WHERE name = 'Technology'), '00000000-0000-0000-0000-000000000001'),
('10000000-0000-0000-0000-000000000003', (SELECT pk FROM tags WHERE name = 'Society'), '00000000-0000-0000-0000-000000000001'),
('10000000-0000-0000-0000-000000000003', (SELECT pk FROM tags WHERE name = 'Analysis'), '00000000-0000-0000-0000-000000000001');

-- step: create_welcome_posts
-- Create initial posts by the Overlord in the welcome topic
INSERT INTO posts (pk, topic_pk, author_pk, content, status, overlord_feedback, submitted_at, approved_at, created_at) VALUES
...
INSERT INTO moderation_events (user_pk, event_type, content_type, content_pk, outcome, moderator_pk, created_at) VALUES
