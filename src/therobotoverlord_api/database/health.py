"""Database health checks and validation for The Robot Overlord API."""
...
class DatabaseHealthChecker:
    ...
    async def check_extensions(self) -> Dict[str, any]:
        ...
        try:
            async with get_db_connection() as connection:
                ...
                missing = [ext for ext in required_extensions if ext not in installed_names]
                ...
                return {
                    ...
                    "message": "All extensions installed" if not missing else f"Missing extensions: {missing}"
                }
        except Exception as e:
    ...
    async def check_tables(self) -> Dict[str, any]:
        ...
        required_tables = [
            "users", "topics", "posts", "tags", "topic_tags",
            "topic_creation_queue", "post_moderation_queue", "private_message_queue",
            "private_messages", "appeals", "flags", "sanctions",
            "badges", "user_badges", "moderation_events", "translations"
        ]
        ...
        try:
            async with get_db_connection() as connection:
                ...
                missing = [table for table in required_tables if table not in existing_names]
                ...
                return {
                    ...
                    "message": "All tables exist" if not missing else f"Missing tables: {missing}"
                }
        except Exception as e:
    ...
    async def check_materialized_views(self) -> Dict[str, any]:
        ...
        try:
            async with get_db_connection() as connection:
                ...
                missing = [view for view in required_views if view not in existing_names]
                ...
                return {
                    ...
                    "message": "All materialized views exist" if not missing else f"Missing views: {missing}"
                }
        except Exception as e:
            logger.error(f"Materialized view check failed: {e}")
            return {
                "status": "unhealthy",
                "message": f"Materialized view check failed: {str(e)}",
                "error": str(e)
            }
        ...
        try:
            async with get_db_connection() as connection:
                ...
                return {
                    ...
                    "message": "All critical indexes exist" if not missing else f"Missing indexes: {missing}"
                }
        except Exception as e:
    ...
    async def get_database_stats(self) -> Dict[str, any]:
        ...
        try:
            ...
            return {
                "status": "unhealthy",
                "message": f"Database stats check failed: {str(e)}",
                "error": str(e)
            }
