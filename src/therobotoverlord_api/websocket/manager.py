...
class WebSocketManager:
    ...
    def subscribe_to_channel(self, connection_id: str, channel: str):
        ...
        if (
            ...
            and channel not in self.connection_info[connection_id].subscriptions
        ):
    ...
    def unsubscribe_from_channel(self, connection_id: str, channel: str):
        ...
        if (
            ...
            and connection_id in self.subscriptions[channel]
        ):
        ...
        if (
            connection_id in self.connection_info
            and channel in self.connection_info[connection_id].subscriptions
        ):
    ...
    async def handle_ping(self, connection_id: str):
        ...
        if connection_id in self.connection_info:
            self.connection_info[connection_id].last_ping = datetime.now(UTC)
