"""Fixed tests for tags API endpoints with proper authentication mocking."""
...
class TestTagsAPIFixed:
    """Test tags API endpoints with fixed authentication."""
    ...
    def test_assign_tag_to_topic_moderator(
        ...
        topic_tag_mock = {
            ...
            "topic_pk": str(uuid4()),
            "tag_pk": str(uuid4()),
            "assigned_by_pk": str(mock_moderator.pk),
            "created_at": "2024-01-01T00:00:00Z",
        }
