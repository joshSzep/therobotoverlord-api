...
class TestAuthServiceTargeted:
    ...
    def auth_service(self):
        ...
        # Make async methods
        service.google_oauth.get_authorization_url = MagicMock(return_value=("auth_url", "state"))
    ...
    async def test_logout_all_sessions(self, auth_service):
        ...
        auth_service.session_service.revoke_all_user_sessions.assert_called_once_with(user_id)
        assert result == 2
