...
class TestBadgeServiceSimple:
    ...
    async def test_delete_badge(self, badge_service):
        ...
        badge_service.badge_repo.update_from_dict.assert_called_once_with(
    ...
    async def test_revoke_badge(self, badge_service):
        ...
        badge_service.user_badge_repo.find_one_by.assert_called_with(
            user_pk=user_id, badge_pk=badge_id
        )
        badge_service.user_badge_repo.delete_by_pk.assert_called_with(
            mock_user_badge.pk
        )
        assert result is True
    ...
    async def test_get_user_badge_summary(self, badge_service):
        ...
        badge_service.user_badge_repo.get_recent_user_badges.assert_called_with(
            user_id, 3
        )
